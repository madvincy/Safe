...
public class CustomerParkingHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_parking_history);
        ...
        mHistoryLayoutManager = new LinearLayoutManager(CustomerParkingHistory.this);
        mHistoryRecyclerView.setLayoutManager(mHistoryLayoutManager);
        mHistoryAdapter = new com.example.madvincy.safe.parkinghistory.historyRecyclerView.HistoryAdapter(getDataSetHistory(), CustomerParkingHistory.this);
