...
public class ParkHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHistoryLayoutManager = new LinearLayoutManager(ParkHistory.this);
        mHistoryRecyclerView.setLayoutManager(mHistoryLayoutManager);
        mHistoryAdapter = new com.example.madvincy.safe.parkinghistory.historyRecyclerView.HistoryAdapter(getDataSetHistory(), ParkHistory.this);
    ...
    private void getUserParkingHistoryIds() {
        DatabaseReference userHistoryDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Parking Places").child(userId).child("history");
...
//                    }
                    ...
                    com.example.madvincy.safe.parkinghistory.historyRecyclerView.HistoryObject obj = new com.example.madvincy.safe.parkinghistory.historyRecyclerView.HistoryObject(ParkHiId, getDate(endingTime),getDate(startingTime));
